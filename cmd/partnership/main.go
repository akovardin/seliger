...
import (
	...
	"gohome.4gophers.ru/kovardin/partnership/app/settings"
	"gohome.4gophers.ru/kovardin/partnership/static"
	// _ "gohome.4gophers.ru/kovardin/partnership/migrations"
)
